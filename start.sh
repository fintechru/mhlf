...
CONTRACT_BIN=`cat build/Bridge.bin`
...
# Тестирование смарт-контракта Bridge, вызов метода getInfo(): 0x5a9b0b89
...
# Тестирование смарт-контракта Bridge, вызов метода setValue() и устновка значения 10
